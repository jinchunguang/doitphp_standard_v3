 ...
 * @version $Id: Script.php 3.0 2014-12-23 16:52:01Z tommy $
 * @package library
 * @since 1.0
 */
...
class Script {
     ...
     *
     * 法二:
     * Script::calendar('#calendar_box', '2010-05-04', '2014-12-21');
     *
     * 法三:(格式:年-月-日 时:分:秒)
     * Script::calendar('#calendar_box', '2010-05-04', '2014-12-21', 'yyyy-MM-dd HH:mm:ss');
     */
